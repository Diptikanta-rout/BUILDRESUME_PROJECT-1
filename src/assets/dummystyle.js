export const landingPageStyles = {
  ...
  // header: "fixed top-0 w-full z-50 bg-green-900/80 backdrop-blur-xl border-b border-gray-700/50",
  ...
  heroSection: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20",
               // flex-col lg:flex-row change to flex-wrap
  heroGrid: "flex flex-col lg:flex-row justify-between gap-10 lg:gap-12 items-center",
  heroLeft: "space-y-8",
