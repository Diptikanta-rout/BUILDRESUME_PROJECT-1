...
const LandingPage = () => {
  ...
  return (
    <div className={landingPageStyles.container}>
      ...
      {/* FOOTER SECTION */}
    <footer className="border-t border-gray-700 bg-gray-900 py-6 sm:py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        {/* Links Section */}
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 mb-6">
          <div>
            <h3 className="text-white font-semibold mb-3">Support</h3>
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-purple-400 text-sm sm:text-base text-slate-400 font-medium">Help Center</a></li>
              <li><a href="#" className="hover:text-purple-400 text-sm sm:text-base text-slate-400 font-medium">Contact Us</a></li>
            </ul>
          </div>
          <div>
            <h3 className="text-white font-semibold mb-3">Legal</h3>
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-purple-400 text-sm sm:text-base text-slate-400 font-medium">Privacy Policy</a></li>
              <li><a href="#" className="hover:text-purple-400 text-sm sm:text-base text-slate-400 font-medium">Terms & Conditions</a></li>
            </ul>
          </div>
          <div>
            <h3 className="text-white font-semibold mb-3">Connect</h3>
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-purple-400 text-sm sm:text-base text-slate-400 font-medium">📘 Facebook</a></li>
              <li><a href="#" className="hover:text-purple-400 text-sm sm:text-base text-slate-400 font-medium">🐙 GitHub</a></li>
              <li><a href="#" className="hover:text-purple-400 text-sm sm:text-base text-slate-400 font-medium">📸 Instagram</a></li>
            </ul>
          </div>
        </div>
