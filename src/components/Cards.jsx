  ...
  {thumbnailImg ? (
    <div className="relative w-full h-full overflow-hidden">
      <img src={thumbnailImg || '/placeholder.svg'} alt="Template Review" className=" w-full h-full
       object-cover group-hover:scale-110 transition-transform duraition-700" />
       ...
       <div className=" absolute inset-0 bg-gradient-to-t from-white/60 via-transparent
        ...
        {/* HOVER EFFECT */}
        <div className=" absolute inset-0 bg-gradient-to-t from-violet-100/30 to-transparent opcity-0
         group-hover:opcity-100 transition-opacity duraition-300">
         </div>
    </div>
  ) : (
