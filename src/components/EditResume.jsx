...
const EditResume = () => {
  ...
  // take back to previous from state or take back to first or to /DASHBOARD
  const goBack = () => {
    const pages = [
      "profile-info",
      "contact-info",
  ...
  // UPDATE ARRAY ITEMS USING INDEX
  ...
  // IT WILL HELP IN CHOOSING THE PREVIEW AS WELL AS HELPS IN DOWNLOAD THE RESUME ALSO SAVES THE RESUME AS IMAGE
  ...
  // THIS FUNCTION WILL HELP IN UPDATE THE RESUME
  ...
  `;
  if (!document.getElementById("__pdf_color_override__")) {
  ...
  return (
    <DashboardLayout>
            ...
            <div className={containerStyles.formContainer}>
                ...
                <div className='p-4 sm:p-6'>
                    ...
                    <div class="md:col-span-2">
                      <label class="block text-bi font-bold text-slate-700 mb-3">Job Description</label>
                      <span>
                        <div className="mt-6 p-4 border rounded-lg bg-gray-50">
                          <ATSOptimizer resume={resumeData} />
                        </div>  
                      </span>
                    </div>
                </div>
      ...
      {/* MODAL DATA HERE */}
       <Modal isOpen={openThemeSelector} onClick={()=> setOpenThemeSelector(false)}
        title="Change Title">
